...
import { Save, Play, Clock, Webhook, Calendar, Mail, Bell, Code, Sparkles, GripVertical, Trash2, X, Send } from "lucide-react";
...
export function WorkflowBuilder() {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      id: "1",
      role: "assistant",
      content: "Hi! I'm your AI assistant. I can help you build workflows, suggest actions, or answer questions about automation.",
    },
  ]);
  ...
  const sendChatMessage = () => {
    ...
    const assistantMessage: ChatMessage = {
      ...
      role: "assistant",
      content: "I understand. Let me help you with that. (This is a demo response - in a real implementation, this would connect to an AI service.)",
    };
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-lg bg-purple-600 p-2 text-white hover:bg-purple-700 transition-colors"
